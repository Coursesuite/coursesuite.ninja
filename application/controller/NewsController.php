...
class NewsController extends Controller
{
    ...
    {
        NewsModel::createNews(Request::post('news_title'), Request::post('news_text'));
        Redirect::to('news');
    }
    ...
    {
        NewsModel::updateNews(Request::post('news_id'), Request::post('news_text'), Request::post('news_title'));
        Redirect::to('news');
    }
