...
class LaunchController extends Controller
{
    ...
    /**
    * @api {get} /launch/{app_key/{token}/
    * @apiName Launch
    * @apiGroup App
    * @apiDescription Launch an app using the specified token
    *                           Note this URL is also generated by the /api/info/ endpoint.
    * @apiParam {String} app_key App Key to launch.
    * @apiParam {String} token Token generated by API.
