 ...
 */
    ...
    public static function getStoreViewModel()
    {
        ...
        if (Session::userIsLoggedIn()) {
            // associate the apps the user has subscribed to with the launch tokens for these apps
            ...
            if (count($current_sub) > 0) {
                ...
                if ($current_sub->status == "active") { // it is active
                    ...
                    if (isset($current_sub->tier->app_ids)) {
                        // unfortunately, you may have an active subscription which has detached from a tier somehow... this will break the model
