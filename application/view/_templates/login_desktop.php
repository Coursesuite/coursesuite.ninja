	        ...
	        <div class="uk-grid-collapse uk-child-width-1-2@s uk-flex-middle" uk-grid>
	            ...
	            <div class="uk-flex uk-flex-middle" uk-height-viewport>
		            <div class="uk-padding-large">
		            	...
		            	<p>You'll remain logged on until you log off.</p>
							...
							<div class="uk-margin">
						        <div class="uk-form-controls">
								    <div class="uk-inline">
							    	    ...
							    	    <input name="onetimepassword" id="login-form-field-password" class="uk-input uk-width-large" type="password" placeholder="Your password (if known)" value="" autocomplete="off">
								    </div>
								</div>
							</div>
							<div class="uk-margin">
