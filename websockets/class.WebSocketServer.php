...
/**
* Handles web socket protocol and request upgrading (e.g. sets response status to 101 and then upgrades socket)
*/
abstract class WebSocketServer
{
    ...
    public function run()
    {
        while (true) {
            ...
            $this->_tick();
            $this->tick();
            // http://www.abrandao.com/2013/06/websockets-html5-php/ - socket_select can eat the cpu
